...
export default function Home() {
  return (
    <div className="min-h-screen bg-white min-w-[430px]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-6">
              <button className="bg-[#799B69] hover:bg-teal-600 text-white px-6 py-[10px] rounded-[8px] text-sm font-medium transition-colors min-w-[168px] min-h-[39px]">
                Join community
              </button>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className=" min-w-[430px] py-[24px] px-[20px] g-[64px]">
          <h2 className="text-2xl font-light text-gray-900 mb-6">
            What InnerSense Measures
          </h2>
          <div className=" g-[64px]">
            
            <div className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4 ">
        ...
        {/* Why It Matters */}
        <section className="min-w-[430px] py-[24px] px-[20px]">
  ...
  <div className="space-y-4 text-sm text-gray-600 text-left">
    ...
    <ul className="space-y-2 list-none pl-0">
      <li className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Lifestyle-related disorders</li>
      <li className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Immune dysfunction</li>
      <li className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Hormonal imbalance</li>
      <li className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Infertility, PCOS, fatigue</li>
      <li className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Heavy metal toxicity</li>
    </ul>
    <p className="mt-4">
      Understanding these patterns allows for targeted, data-backed care that supports true healing.
        ...
        <section className="min-w-[430px] py-[24px] px-[20px] g-[64px]">
          ...
          <div className="space-y-4 text-sm text-gray-600">
            <p  className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Uses clinical-grade spectrophotometry</p>
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Measures the absorbance of light through skin tissue</p>
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Compares real-time data with global database (700+ studies)</p>
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Reports delivered in under 60 seconds</p>
        ...
        <section className=" min-w-[430px] py-[24px] px-[20px] g-[64px]">
          ...
          <div className="space-y-4 text-sm text-gray-600">
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Instant diagnostic report</p>
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Measures the absorbance of light through skin tissue</p>
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">Supplementation recommendations</p>
            <p className="border-b-[1px] min-w-[390px] border-[#BDC5E4] pb-4">A personalised plan tailored to your current biological needs</p>
      ...
      {/* Footer */}
      <footer className=" relative bg-white border-t mt-16 min-w-[430px] min-h-[916px] pb-[24px]  ">
        ...
        <div className=" relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 ">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="min-w-[430px] min-h-[730px] px-[20px] g-[54px]">
                <div className="min-w-[390px] min-h-[612px] gap-[44px]">
                    <div className=" flex min-w-[390px] min-h-[308px]">
                         <div className="min-w-[211px] min-h-[308px]">
                           <h4 className="font-medium text-gray-900">Location</h4>
                           <p>Inside Kanwar Nursing Home, Shankar Nagar, Raipur</p>
                            ...
                            <div>
                              ...
                              <ul className="space-y-2 text-sm text-gray-600">
                                ...
                                <li><a href="#" className="hover:text-gray-900">Advance Medical Equipment</a></li>
                              </ul>
                      

                    </div>
                          </div>
                       <div className="min-w-[390px] min-h-[260px] g-[12px] mt-6">
